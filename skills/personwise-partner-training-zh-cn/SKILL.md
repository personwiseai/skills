---
name: personwise-partner-training-zh-cn
description: "当用户要求根据提供的资料制作合作伙伴培训时使用。触发语：合作伙伴培训；合作伙伴 Onboarding；渠道伙伴培训；经销商培训。产出有依据支撑、学习者可随时语音打断提问的数字人互动课程。不得编造无依据的事实，不得声称外部认证、能力资质或现实任务已完成。在用户明确同意后，本技能会安装或更新官方 PersonWise CLI 并使用浏览器 OAuth。其他课程创建请求仅在该用户明确使用本技能时处理。"
license: MIT
...
用用户已批准的合作伙伴项目材料，为渠道伙伴和经销商制作一门数字人互动培训课程。伙伴
拿到产品故事、成交流程和规则，并能在 ramp 时向课程提问。

## 何时使用本 Skill

请求匹配以下表达时使用：合作伙伴培训；合作伙伴 Onboarding；渠道伙伴培训；经销商
培训。不要用于直销团队的就绪培训——那是另一个场景——也不要用于起草伙伴协议或商务
条款。

## 依据与边界

本场景为证据锁定场景：课程只承载已批准的项目承诺。

- 绝不承诺资料未明确批准的佣金、返点、区域、线索分配、法律地位或收益。
- 已批准的主张和品牌规则严格原样承载；伙伴会复述课程说的话，未经批准的措辞会变成
  公开风险。
- 超出资料的商务或合同问题，回到用户的伙伴团队，不即兴作答。

## 设计课程产物

按材料调整，大多数伙伴课程适用这条教学弧：

1. 合作关系：一起卖什么、服务谁、伙伴为什么赢。
2. 产品故事：伙伴可以转述给客户的已批准叙事。
3. 成交流程：线索、报备和交接在这个项目里实际怎么走。
4. 规则：已批准的主张、品牌规范，以及使用前究竟需要什么签批。
5. 自检与升级：确认就绪；成交支持和项目问题找谁。

视觉保持概念化——项目结构图、成交流程图——绝不编造伙伴门户、层级表或佣金表。讲解人
基调：自信，合作伙伴气质。
...
{
  "skill_invocation": {
    "skill_id": "personwise-partner-training-zh-cn",
    "skill_version": "2.1.2"
  }
}
```
