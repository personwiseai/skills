...
用用户自己的制度、法规摘要和培训材料，制作一门数字人互动合规课程。课程把必须掌握的
要求讲得明白、可问——它绝不替代背后的法律文本。

## 何时使用本 Skill

请求匹配以下表达时使用：合规培训；职场合规培训；监管合规培训。不要用于解释个人的
法律风险，也不要用于从零起草合规制度。
...
- 课程本身绝不构成法律合规、认证、执照或专业意见——凡提到完成的地方都要明说。
- 义务、阈值和时限严格按所提供资料原文承载；绝不把法律要求转述得更弱或更强。
- 个案情况指路到资料中具名的合规负责人，不即兴解读。

## 设计课程产物

按材料调整，大多数合规课程适用这条教学弧：

1. 为什么有这条规则：它控制什么风险、保护谁。
2. 规则要求什么：义务，严格按来源陈述。
3. 实际中意味着什么：资料里的场景，按记载的方式判定。
4. 灰色地带与升级：哪里需要判断，究竟由谁决定。
5. 自检与确认路径：确认理解；正式流程在哪里。

视觉严肃、结构化——要求地图、决策树。绝不编造监管机构标识、法律条文引用或官方印章。
讲解人基调：严肃、精确，经法务审阅的气质。
