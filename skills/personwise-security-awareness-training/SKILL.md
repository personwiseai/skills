...
Build an interactive digital-human security awareness course grounded in the user's own security
policies and awareness materials. The course raises recognition and reporting behavior — it
never claims to make anyone secure.

## When to use this Skill

Use it when the request matches: security awareness training; cyber awareness training;
employee security training. Do not use it for technical security operations training, incident
response certification, or penetration-testing instruction.
...
- Never claim the course eliminates risk, guarantees security, certifies practical capability,
  or replaces the security team — awareness reduces risk, it does not remove it.
- Teach only the policies, indicators, and reporting paths the supplied materials define;
  never invent threat statistics, breach stories, or attacker techniques as fact.
- Suspected incidents always route to the reporting channel named in the materials, not to
  improvised handling advice.

## Design the course

Adapt to the material, but this arc works for most awareness courses:

1. Why this matters: the threats the materials name and what they cost.
2. Recognize: the indicators employees should spot, from the supplied policy.
3. Act: the documented response — what to do and what never to do.
4. Report: exactly where and how to report, and what happens next.
5. Self-check: confirm recognition and the reporting reflex.

Keep visuals clear and attention-worthy without inventing fake phishing screenshots presented
as real attacks; conceptual examples are fine when labeled as illustrations. Presenter: alert,
practical, security-team energy.
