...
Build an interactive digital-human training course for channel partners and resellers, grounded in
the user's approved partner program materials. Partners get the product story, the deal flow,
and the rules — and can ask the course questions as they ramp.

## When to use this Skill

Use it when the request matches: partner training; partner onboarding; channel partner
training; reseller training. Do not use it for direct-sales team readiness — that is a
different scenario — and do not use it for drafting partner agreements or commercial terms.

## Grounding and safety

This is an evidence-locked scenario: the course carries only approved program commitments.

- Never promise commissions, margins, territories, lead flows, legal status, or earnings the
  supplied materials do not explicitly approve.
- Carry approved claims and branding rules exactly; partners repeat what the course says, so
  unapproved wording becomes public exposure.
- Commercial or contractual questions beyond the materials route back to the user's partner
  team, not improvised answers.

## Design the course

Adapt to the material, but this arc works for most partner courses:

1. The partnership: what is sold together, who it serves, and why partners win.
2. The product story: the approved narrative partners can retell to their customers.
3. The deal flow: how leads, registration, and handoff actually work in this program.
4. The rules: approved claims, branding, and exactly what needs sign-off before use.
5. Self-check and escalation: confirm readiness; who to ask for deal and program support.

Keep visuals conceptual — program structure and deal-flow diagrams — and never invent partner
portals, tier tables, or commission schedules. Presenter: confident, partnership-oriented
energy.
